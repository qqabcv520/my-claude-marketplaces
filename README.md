...
```bash
claude plugin marketplace add qqabcv520/my-claude-marketplaces
```
...
```bash
# 安装项目规范管理插件
claude plugin install project-spec@my-claude-marketplaces

# 安装文件保护插件
claude plugin install file-guard@my-claude-marketplaces

# 安装 Codex 集成插件
claude plugin install codex@my-claude-marketplaces

# 安装知识库管理插件
claude plugin install knowledge-base@my-claude-marketplaces

# 安装智能通知插件
claude plugin install notify@my-claude-marketplaces
```
